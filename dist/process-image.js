...
function processImage(input) {
    return __awaiter(this, void 0, void 0, function () {
        var image, srcMeta, resized, output, _a, data, blurMeta;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    image = sharp_1.default(input).rotate();
                    return [4 /*yield*/, image.metadata()];
                case 1:
                    srcMeta = _b.sent();
                    resized = image.resize(Math.min(srcMeta.width, 16), Math.min(srcMeta.height, 16), { fit: 'inside' });
                    output = resized.webp({
                        quality: 20,
                        alphaQuality: 20,
                        smartSubsample: true
                    });
                    return [4 /*yield*/, output.toBuffer({
                            resolveWithObject: true
                        })];
                case 2:
                    _a = _b.sent(), data = _a.data, blurMeta = _a.info;
                    return [2 /*return*/, {
                            width: srcMeta.width,
